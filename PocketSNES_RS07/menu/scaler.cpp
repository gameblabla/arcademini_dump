...
void upscale_256x240_to_384x272_for_480x272(uint32_t *dst, uint32_t *src, int width)
{
    int midh = 272 / 2;
    int Eh = 0;
    int source = 0;
    ...
    for (y = 0; y < 272; y++)
    {
        ...
        *dst += 480 + (480 - 384) / 2; 
        Eh += SNES_HEIGHT_EXTENDED; if(Eh >= 272) { Eh -= 272; dh++; }
    }
}

void upscale_256x224_to_480x272(uint32_t *dst, uint32_t *src)
{
    int midh = 272 / 2;
    int Eh = 0;
    int source = 0;
...
void upscale_256x240_to_480x272(uint32_t *dst, uint32_t *src)
{
    int midh = 272 / 2;
    int Eh = 0;
    int source = 0;
