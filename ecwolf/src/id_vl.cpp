...
unsigned screenHeight = 272;
unsigned fullScreenWidth = 480;
unsigned fullScreenHeight = 272;
unsigned windowedScreenWidth = 480;
unsigned windowedScreenHeight = 272;
unsigned int screenBits = 16;      // use "best" color depth according to libSDL
