...
{
	// Initialize SDL
	int flags = (options.vsync ? SDL_HWSURFACE : SDL_SWSURFACE);
	...
	screen = SDL_SetVideoMode(480, 272, 16, SDL_HWSURFACE | SDL_ANYFORMAT);
#else
	screen = SDL_SetVideoMode(320, 480, 16, SDL_HWSURFACE | SDL_ANYFORMAT);
#endif
	if (0) {
