...
void readkey() 
{
	...
	if (SDL_JoystickGetButton(s_Joysticks[0], 1)) g_key = 308;
	else if (SDL_JoystickGetButton(s_Joysticks[0], 2)) g_key = 306;
	else if (SDL_JoystickGetButton(s_Joysticks[0], 8)) g_key = 27;
	else if (SDL_JoystickGetButton(s_Joysticks[0], 9)) g_key = 13;
	else if (SDL_JoystickGetAxis(s_Joysticks[0], 0) < -500) g_key = 276;
	else if (SDL_JoystickGetAxis(s_Joysticks[0], 0) > 500) g_key = 275;
	else if (SDL_JoystickGetAxis(s_Joysticks[0], 1) < -500) g_key = 273;
	else if (SDL_JoystickGetAxis(s_Joysticks[0], 1) > 500) g_key = 274;
	else g_key = 0;
